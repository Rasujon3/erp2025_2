...
@section('content')
    <div class="container-fluid">
        @include('leads::leads.partials.content_header')
            ...
            <div class="col-md-12" id="mainColumn">
                ...
                <div class="tab-content mt-3" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="grid" role="tabpanel">
                        @include('leads::leads.partials.card_view')
                    </div>

                    <!-- List View Tab -->
                    <div class="tab-pane fade" id="list" role="tabpanel">
                        @include('leads::leads.partials.list_view')
                    </div>
                </div>

                @include('leads::leads.partials.modals')
            </div>
            {{-- below filter --}}
            @include('leads::leads.partials.side_filter')
        </div>
    </div>
    @include('leads::leads.templates.templates')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadLeadStatusesGridView(loadMore = false, searchQuery = null, pageNumber = null) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const editRoute = "{{ route('leads.edit', ':id') }}";
                        const viewRoute = "{{ route('leads.view', ':id') }}";
                        const data = response.data;
                        if (data.length) {
                            dataSize = data.length;
                            data.forEach(lead => {
                                let colorData = [{ 'color': lead.color }];
                                 ...
                                 <div class="col-md-3 col-lg-3  ">
                                    <div class="customer-card border rounded p-3">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <p class="mb-0 txtColor">Mobile</p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <p class="mb-0 fw-bold">${lead.name}</p>
                                            <p class="mb-0 fw-bold">${lead.mobile}</p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <p class="mb-0 txtColor">priority</p>
                                        </div>
                                        <div class="d-flex justify-content-between">
                                            <p class="mb-0 fw-bold">${lead.priority}</p>
                                        </div>
                                        <div class="card-footer text-end mt-2">
                                            <a href="${editRoute.replace(':id', lead.id)}" class="btn btn-primary btn-sm" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <button class="btn btn-danger btn-sm delete-currency" data-id="${lead.id}" title="Delete">
            ...
            $(document).on('click', '#confirmDelete', function() {
                ...
                const deleteCountryUrl = "{{ route('leads.destroy', ':id') }}".replace(':id', id);
                $.ajax({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                const viewRoute = "{{ route('leads.view', ['lead' => ':id']) }}";
