...
@section('content')
    <div class="container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="hstack align-items-center">
                        ...
                        <button class=" fw-bold txtColor" style="background: none;border:none;">Update Lead Source</button>
                    </div>
                </div>
        ...
        <form method="POST" action="{{ route('lead.source.update', ['leadSource' => $leadSource->id]) }}"
                    ...
                    <div class="col-md-6 mb-4 position-relative">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="fullName" name="name"
                                placeholder="Enter Name" required value="{{ $leadSource->name ?? '' }}">
